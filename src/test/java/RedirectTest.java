...
import contextis.OpenBankingAuthorisationRedirect;
...
public class RedirectTest {
    ...
    private OpenBankingAuthorisationRedirect obRedirect = new OpenBankingAuthorisationRedirect();
    ...
    private String createSignedJwt(String payload) {
        ...
        return this.obRedirect.generateSignedJwt(payload, privKey, kid, alg);
    }
