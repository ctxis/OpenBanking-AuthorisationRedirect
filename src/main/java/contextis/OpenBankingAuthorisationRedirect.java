...
public class OpenBankingAuthorisationRedirect {
    ...
    public String generateSignedJwt(String payload, PrivateKey privateKey, String kid, String alg) {
    ...
    public boolean verifyJwt(String jwt, String alg, PublicKey publicKey, String payload) {
